...
const MapboxRace3DView: React.FC<MapboxRace3DViewProps> = ({
  ...
  }, [mapContainerRef, racerPosition.latitude, racerPosition.longitude, racerPosition.rotation, mapRef]);
  ...
  return (
    <div className="w-full h-full relative">
      ...
      <RaceWinnerModal
        isVisible={parameters.raceFinished}
        winner={parameters.raceWinner}
        modelId={modelId}
